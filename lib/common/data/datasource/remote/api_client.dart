...
import 'package:child_community/common/data/datasource/remote/exception.dart';
...
class ApiClient extends GetxService {
  ...
  ApiClient({required this.appBaseUrl, required this.sharedPreferences}) {
    token = sharedPreferences.getString(ShareKey.token);
  ...
  Future<Response> postData(String uri, dynamic body, {Map<String, String>? headers, int? timeout}) async {
    try {
      if(foundation.kDebugMode) {
        debugPrint('====> API Call: BaseUrl$appBaseUrl $uri\nHeader: $_mainHeaders');
